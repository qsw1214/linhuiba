<template  lang="html">
  <div class="license-passworld">
    <section class="CM-content">
      ...
      <div class="CM-center">
        <input class="" placeholder="请输入短信验证码" maxlength="6" type="text" v-model.trim="captcha"  max="6" />
    ...
    <div class="uoload-top" v-show="!isUpload">
      ...
      <router-link to="/appLicenseExample" class="upload-example">查看案例<span></span></router-link>
    </div>
      ...
      changeMobile () {
        ...
        captchaBoolean(parm).then(res => {
          ...
          lisetenToChangeMobile(parms).then(res => {
            ...
            this.appSuccessCallback(mobile)
          }).catch(e => {
            this.$vux.toast.text(e.msg, 'middle');
          })
        }).catch(e => {
