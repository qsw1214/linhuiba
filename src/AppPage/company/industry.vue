<template lang="html">
  <div class="industry-wrap">
      <app-head go-back="true" shortenHead="true">
      ...
      <section class="I-content">
        ...
        <ul class="select-children" v-else>
          <li @click.stop="chooseIndustry(item)" v-for="(item,index) in industryChlidren">{{item.display_name}}<span class="imprint" v-show="item.falg == true"></span></li>
        </ul>
      </section>
