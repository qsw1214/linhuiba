  ...
  <div class="company-certificate">
    ...
    <div v-show="!haveInfo">
      ...
      <div class="enterprise-upload">
        ...
        <vUploadImg ref="upload" name="img1234567" :fileType="fileType" class="profile-avatar-upload" max=1 :picArr="pic_url" ></vUploadImg>
      </div>
      <div class="upload-comment">
        <p>1. 图片支持.jpg/.jpeg/.png 格式，大小不得超过8M。</p>
        <p>2. 请上传营业执照副本，照片需完整、清晰可见，内容真实有效。</p>
        <p>3. 如遇问题，可拨打客服热线<a href="tel:400-1028-028">400-1028-028</a>(09:00-18:00)。</p>
      </div>
    </div>
    <div v-show="haveInfo">
