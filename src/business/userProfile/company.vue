  ...
  <div class="company">
      ...
      <section class="C-main" v-show="hiddenCompany == undefined">
        <ul class="C-list">
          ...
          <router-link :to="{name: 'industry', query: {type: '0'}}" >
            <li class="C-item bt1">
          ...
          <router-link :to="{name: 'industry', query: {type: '1'}}" >
            <li class="C-item ">
          ...
          <router-link :to="{name: 'companyChoseCity'}" >
            <li class="C-item">
          ...
          <li class="C-item no-angle item-two pt10" v-show="!isWeiXin">
...
export default {
  ...
  components: { vHead, Icon, PopupPicker ,vUploadImg, Popup, XSwitch, vUploadFile},
  filters: {
    twoPoint
  },
  directives: {
  ...
  computed: {
    ...mapState([
      ...
      'setSiteIntentionFoodSafeImages'
    ]),
  },
  ...
  methods: {
    ...
    changeDataTwo(obj) {
     ...
     choseLevel(){
      ...
      if (!this.siteIntention.areaAndPrice || (!this.siteIntention.areaAndPrice.minArea && this.siteIntention.areaAndPrice.minArea != '')) {
        this.minArea = demand_area
      }
      if (!this.siteIntention.areaAndPrice || (!this.siteIntention.areaAndPrice.maxArea && this.siteIntention.areaAndPrice.maxArea != '')) {
        this.maxArea = demand_max_area
      }
      if (!this.siteIntention.areaAndPrice || (!this.siteIntention.areaAndPrice.minPrice && this.siteIntention.areaAndPrice.minPrice != '')) {
        this.minPrice = acceptable_minimum_price
      }
      if (!this.siteIntention.areaAndPrice || (!this.siteIntention.areaAndPrice.maxPrice && this.siteIntention.areaAndPrice.maxPrice != '')) {
