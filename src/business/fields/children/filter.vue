<template lang="html">
  <view-box  class="filter-wraper">
    ...
    <!--<div class="drop">-->
      <!--<div class="title">-->
         <!--<div class="title-left">价格区间(元 / 天)</div>-->
      <!--</div>-->
      <!--<div class="type-box">-->
    ...
    <div class="drop">
      ...
      <div class="type-box">
         <input type="number" placeholder="最小面积" autocomplete="off" v-model="minimum_area"><span class="center-line"></span><input type="number" placeholder="最大面积" autocomplete="off" v-model="maximum_area">
      </div>
    </div>
...
//      this.$router.push();
    ...
    submit(){
      ...
      if( this.maximum_area ){
        if( !FLOAT_REG.test( this.maximum_area ) ){
          this.maximum_area = '' ;
          this.$vux.toast.text( '你输入的最大面积只能为数字或者两位小数' ); return ;
        }else{
          this.childFilterData.maximum_area = +this.maximum_area ;
        }
      }
      if( this.filterData.lowPrice ){
        this.childFilterData.lowPrice = this.filterData.lowPrice ;
      }
      if( this.filterData.highPrice ){
        this.childFilterData.highPrice = this.filterData.highPrice ;
      }
      if( this.filterData.page ){
        this.childFilterData.page = this.filterData.page ;
      }
      if( this.filterData.pageSize ){
        this.childFilterData.pageSize = this.filterData.pageSize ;
      }
      if( this.filterData.resource_type ){
        this.childFilterData.resource_type = this.filterData.resource_type ;
      }
      ...
      if(this.filterData.self_support){
        this.childFilterData.self_support = this.filterData.self_support ;
      }
      if(this.filterData.subsidy){
        this.childFilterData.subsidy = this.filterData.subsidy ;
      }
      if(this.filterData.hot){
        this.childFilterData.hot = this.filterData.hot ;
      }
      ...
      if( this.keywords ){
        this.$router.push({path: '/fields' , query: { keywords: encodeURIComponent( this.keywords  ) } });
      }else{
    ...
    showSelected(){
      ...
      if( JSON.stringify(this.filterData) != "{}" ){
        ...
        this.maximum_area = this.filterData.maximum_area;
      }
