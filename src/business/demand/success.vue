  ...
  <div class="demand-wraper">
    ...
    <div class="btn-box">
      <div class="btn go-mydemand">
        <router-link to="/mydemand">查看需求</router-link>
      </div>
    ...
    <div class="list" v-load-more="loadingMore" type="1">
      <div class="title">为你推荐 <span class="txt">（根据您发布需求中“{{ $route.query.city }}”、“{{ $route.query.field_type }}”推荐）</span></div>
      <div class="wraper">
        <router-link :to="{ name : 'fieldsDetail' , params : { id : item.sid } }" class="item" v-for="( item , index) in list" :key="index">
          <div class="img-box">
